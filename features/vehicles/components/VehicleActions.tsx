        ...
        <>
            <div className="mt-auto flex gap-4 pt-10">
                <button
                    ...
                    className="flex-grow bg-slate-900 text-white py-6 rounded-[2rem] font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-2xl hover:-translate-y-1 active:translate-y-0"
                >
